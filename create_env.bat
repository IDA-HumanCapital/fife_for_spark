...
pip install --trusted-host pypi.org hyperopt lifelines pandas pyspark seaborn jupyter jupyter_core ipykernel fife findspark pyarrow koalas databricks sphinx--user

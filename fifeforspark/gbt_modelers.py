"""FIFEforSpark modelers based on PySpark GBT, which trains gradient-boosted trees."""
...
class GBTModeler(Modeler):
    ...
    Attributes:
        ...
        model (list): A trained LightGBM model (gbt.basic.Booster) for each
            lead length.

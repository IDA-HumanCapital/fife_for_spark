...
Institute for Defense Analyses. **FIFEforSpark: Finite-Interval Forecasting Engine for Spark [software].** https://github.com/IDA-HumanCapital/fifeforspark, 2020. Version 0.x.x.
...
.. code-block:: latex
    ...
    @misc{
        ...
        howpublished={https://github.com/IDA-HumanCapital/fifeforspark},
        note={Version 0.x.x},
        year={2021}
    }
...
:IDA Principal Investigator: Dr. Alan Gelder, agelder@ida.org
